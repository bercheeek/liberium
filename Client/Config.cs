	...
	internal class Config
	{
		...
		public static void Init()
		{
			...
			if (Config.Install == EncryptString.Decode("true"))
			{
				...
				Config.CmdlineAutorun = EncryptString.Decode(Config.CmdlineAutorun);
				Config.WmiAutorun = EncryptString.Decode(Config.WmiAutorun);
		...
		public static string CmdlineAutorun = "%CmdlineAutorun%";

		// Token: 0x0400001F RID: 31
		public static string WmiAutorun = "%WmiAutorun%";
